...
public class BookCustomersJPanel extends javax.swing.JPanel {
    ...
    public BookCustomersJPanel(JPanel userProcessContainer, TravelAgency travelAgency, Flight flight) {
        initComponents();
        this.userProcessContainer=userProcessContainer;
        this.travelAgency = travelAgency;
        this.flight = flight;
        
        // set text field by the flight info
        for (FlightSchedule fS: travelAgency.getMTS().getmTS()) {
            for(Flight flight2: fS.getFlightSchedule()) {
                if (flight2.equals(flight)) {                    
                    ...
                    priceTxt.setText(flight.getSeat().get(0).getPrice()+"");
                }
            }
        }
    ...
    private void bookBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookBtnActionPerformed
        ...
        for (Seat seat: flight.getSeat()) {
            if (seat.getColPosition().equals(seatPosCBox.getSelectedItem().toString()) 
                ...
                seatMessage+="Row: ";
                seatMessage+=seat.getRow()+"\n";
                seatMessage+="Column: ";
                if (seat.getColGroup() == 1)
                    seatMessage+="Left ";
                else
                    seatMessage+="Right ";
                seatMessage+=seat.getColPosition()+"\n";
